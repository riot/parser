...
module.exports = {
  ...
  'multiple <script> tags with src attribute are not supported': {
    ...
    expected: [{'type': 1, 'name': 'div', 'start': 0, 'end': 5}, {
      'type': 1,
      'name': 'script',
      'start': 5,
      'end': 37,
      'attributes': [{'name': 'src', 'value': 'path/to/somewhere', 'start': 13, 'end': 36, 'valueStart': 18}]
    }, {'type': 1, 'name': '/script', 'start': 37, 'end': 46}, {
      'type': 1,
      'name': 'script',
      'start': 46,
      'end': 54
    }, {'type': 1, 'name': '/script', 'start': 54, 'end': 63}, {'type': 1, 'name': '/div', 'start': 63, 'end': 69}]
  },
