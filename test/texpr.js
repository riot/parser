  ...
  'must preserve inner spaces': {
    ...
    expected: [
      { type: _T.TAG, name: 'p', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: ' 0 ', start: 3, end: 8 }],
      },
  ...
  'must handle double quotes inside unquoted expression': {
    ...
    expected: [
      { type: _T.TAG, name: 'p', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: '"<a>"', start: 7, end: 14 }],
      },
  ...
  'must handle double quotes inside double quoted expression': {
    ...
    expected: [
      { type: _T.TAG, name: 'p', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: '"<a>"', start: 8, end: 15 }],
      },
  ...
  'text inside tag, simple expression': {
    ...
    expected: [
      { type: _T.TAG, name: 'div', start: 0, end: 5 },
      {
        ...
        expressions: [{ text: ' 0 ', start: 11, end: 16 }],
      },
  ...
  'text inside tag, expression with embeded brackets': {
    ...
    expected: [
      { type: _T.TAG, name: 'div', start: 0, end: 5 },
      {
        ...
        expressions: [{ text: ' "{" ', start: 11, end: 18 }],
      },
  ...
  'text inside tag, ternary with embeded brackets': {
    ...
    expected: [
      { type: _T.TAG, name: 'div', start: 0, end: 5 },
      {
        ...
        expressions: [{ text: " s === \"{\" ? '' : '}' ", start: 11, end: 35 }],
      },
  ...
  'text inside tag, literal regex in expression': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: ' s: /}/ ', start: 3, end: 13 }],
      },
  ...
  'text inside tag, tricky regex': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: ' a-++/}/i.lastIndex ', start: 3, end: 25 }],
      },
  ...
  'tricky regex': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: ' .../5./2/ ', start: 3, end: 16 }],
      },
  ...
  'text inside tag, regex with tags inside': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: ' a + /<g></g> b ', start: 4, end: 22 }],
      },
  ...
  'text inside tag, shortcut': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: ' a: 1, "b": fn(a,b) ', start: 3, end: 25 }],
      },
      { type: _T.TAG, name: '/a', start: 25, end: 29 },
    ],
  },
  ...
  'text with expression inside textarea': {
    ...
    expected: [
      { type: _T.TAG, name: 'textarea', start: 0, end: 10 },
      {
        ...
        expressions: [{ text: 'a', start: 14, end: 17 }],
      },
        ...
        attributes: [
          {
            ...
            valueStart: 8,
            expressions: [{ text: 'e', start: 8, end: 11 }],
          },
        ],
      },
    ],
        ...
        attributes: [
          {
            ...
            expressions: [{ text: 'foo.bar', start: 3, end: 15 }],
          },
        ],
      },
    ],
        ...
        attributes: [
          {
            ...
            expressions: [{ text: 'item in items', start: 8, end: 23 }],
            valueStart: 8,
          },
          {
            start: 24,
            isSpread: true,
            expressions: [{ text: 'foo.bar', start: 24, end: 36 }],
            end: 36,
          },
        ],
        isSelfClosing: true,
        ...
        attributes: [
          {
            isSpread: true,
            start: 3,
            expressions: [{ text: 'foo.bar', start: 3, end: 17 }],
            end: 17,
          },
        ],
        isSelfClosing: true,
    ...
    expected: [
      {
        ...
        attributes: [
          ...
          },
          {
            isSpread: true,
            start: 18,
            expressions: [{ text: 'foo.baz', start: 18, end: 32 }],
            end: 32,
          },
        ],
        isSelfClosing: true,
        ...
        attributes: [
          {
            start: 3,
            name: 'href',
            expressions: [{ text: 'href', start: 3, end: 9 }],
            end: 9,
          },
        ],
        isSelfClosing: true,
    ...
    expected: [
      {
        ...
        attributes: [
          ...
          },
          {
            start: 10,
            name: 'target',
            expressions: [{ text: 'target', start: 10, end: 18 }],
            end: 18,
          },
        ],
        isSelfClosing: true,
        ...
        attributes: [
          {
            start: 3,
            name: 'href',
            expressions: [{ text: ' href ', start: 3, end: 11 }],
            end: 11,
          },
        ],
        isSelfClosing: true,
        ...
        attributes: [
          {
            ...
            valueStart: 7,
            expressions: [{ text: ' e ', start: 7, end: 12 }],
          },
        ],
      },
    ],
        ...
        attributes: [
          {
            ...
            expressions: [{ text: ' e ', start: 12, end: 17 }],
            valueStart: 12,
          },
        ],
        isSelfClosing: true,
        ...
        attributes: [
          {
            ...
            valueStart: 8,
            expressions: [{ text: "'e'", start: 8, end: 13 }],
          },
        ],
      },
    ],
        ...
        attributes: [
          {
            ...
            valueStart: 8,
            expressions: [{ text: 'e', start: 10, end: 13 }],
            unescape: '{',
          },
        ],
      },
  ...
  'ES6 expression inside tag': {
    ...
    expected: [
      { type: _T.TAG, name: 'div', start: 0, end: 5 },
      {
        ...
        expressions: [{ text: ' `bar${baz}` ', start: 11, end: 26 }],
      },
  ...
  'ES6 with ES6 backquote inside': {
    ...
    expected: [
      { type: _T.TAG, name: 'div', start: 0, end: 5 },
      {
        ...
        expressions: [{ text: ' `bar${`}`}` ', start: 11, end: 26 }],
      },
      { type: _T.TAG, name: '/div', start: 26, end: 32 },
    ],
  },
  ...
  'ES6 with ES6 backquote inside #2': {
    ...
    expected: [
      { type: _T.TAG, name: 'div', start: 0, end: 5 },
      {
        ...
        expressions: [{ text: ' `bar${``}` ', start: 11, end: 25 }],
      },
  ...
  'Custom brackets `[ ]`': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: '1+2', start: 3, end: 8 }],
      },
  ...
  'Custom brackets `[ ]` w/nested brackets': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: 'a[1]', start: 3, end: 9 }],
      },
  ...
  'Custom brackets `[[ ]]` w/nested brackets': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: 'a[1]', start: 3, end: 11 }],
      },
  ...
  'Custom brackets `[ ]` w/preceding escaped bracket': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        unescape: '[',
        expressions: [{ text: '1+2', start: 5, end: 10 }],
      },
  ...
  'Custom brackets `([ ])` w/nested brackets': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: 'a([1])', start: 3, end: 13 }],
      },
      { type: _T.TAG, name: '/a', start: 13, end: 17 },
    ],
  },
  ...
  'Custom brackets `{{ }` w/nested brackets': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: '{}', start: 3, end: 8 }],
      },
      { type: _T.TAG, name: '/a', start: 8, end: 12 },
    ],
  },
  ...
  'Custom brackets `${ }` w/ES6 inside': {
    ...
    expected: [
      { type: _T.TAG, name: 'a', start: 0, end: 3 },
      {
        ...
        expressions: [{ text: '`a${0}`', start: 3, end: 13 }],
      },
      { type: _T.TAG, name: '/a', start: 13, end: 17 },
    ],
  },
        ...
        attributes: [
          {
            ...
            valueStart: 6,
            expressions: [{ text: ' `a${0}` ', start: 6, end: 18 }],
          },
        ],
        isSelfClosing: true,
      },
        ...
        attributes: [
          {
            ...
            valueStart: 5,
            expressions: [{ text: ' `a${0}` ', start: 5, end: 17 }],
          },
        ],
        isSelfClosing: true,
      },
        ...
        attributes: [
          {
            ...
            valueStart: 5,
            expressions: [{ text: ' `a${0}` ', start: 5, end: 16 }],
          },
        ],
        isSelfClosing: true,
      },
        ...
        attributes: [
          {
            ...
            unescape: '${',
            valueStart: 6,
            expressions: [{ text: '{}', start: 9, end: 14 }],
          },
        ],
        isSelfClosing: true,
      },
